...
if [ "$num" = 1 ]; then
    ...
    #cloudflare
    cloudflaregetfile 'https://xxx.v2026h.com/xxx_box/xxx_install'
elif [ "$num" = 4 ]; then
    #cloudflare
    cloudflaregetfile 'https://xxx.v2026h.com/xxx_box/xxx_install_mini'
elif [ "$num" = 5 ]; then
    #jsdelivr
